  ...
  <body>
    <table>
        <tbody>
            ...
            <tr>
                <td class="text" colspan="2">Código: <br/>{{  $lote->LOTE_IDENTIFY }}</td>
            </tr>
            <tr>
                <td class="description" colspan="2">Descrição: <br/>{{  $lote->LOTE_BIG_DESC }}</td>
            </tr>
        </tbody>
    </table>
  </body>
