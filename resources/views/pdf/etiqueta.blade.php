  ...
  <body>
    <table>
        <tbody>
            ...
            <tr>
                <td class="text" width="60%">Código: <br/>{{  $lote->LOTE_IDENTIFY }}</td>
            </tr>
            <tr>
                <td class="description" width="60%">Descrição: <br/>{{  $lote->LOTE_BIG_DESC }}</td>
            </tr>
        </tbody>
    </table>
  </body>
