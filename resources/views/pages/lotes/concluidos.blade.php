        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div id="accordion" role="tablist">
                @foreach ($lotes->groupBy('FAC_ID') as $idFac => $faccaoGroup)
                    <div class="card card-collapse">
                        <div class="card-header" role="tab" id="headingOne">
                            <h5 class="mb-0">
                                <a data-toggle="collapse" href="#collapse{{$idFac}}" aria-expanded="false" aria-controls="collapse{{$idFac}}">
                                    {{$faccoes->where('id',$idFac)->first()->FAC_NAME}}
                                    <i class="material-icons">keyboard_arrow_down</i>
                                </a>
                            </h5>
                        </div>

                        <div id="collapse{{$idFac}}" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                <div class="">
                                    <table class="table">
                                      ...
                                      <tbody>
                                        ...
                                        @else
                                          @foreach ($faccaoGroup->sortByDesc('id') as $lote)
                                            <tr>
                                              <td>{{ $lote->id }}</td>
