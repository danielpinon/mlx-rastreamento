                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    <button data-toggle="modal" data-target="#newUserModal"
                                        ...
                                        @foreach ($users as $user)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($user->subtype == 1)
                                                      <span class="badge badge-info">Ger. de Lote</span>
                                                    @else
                                                      <span class="badge badge-info">Ger. de Setor/Facção</span>
                                                    @endif
                                                </td>
                ...
                <form action="{{ route('user.registro') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                  <label class="">Tipo de Conta:</label>
                                  <select class="form-control" name="subtype">
                                      <option value="0">Admin (Acesso geral)</option>
                                      <option value="1">Gestor de Lote</option>
                                      <option value="2">Gestor de Setor/Facção</option>
                                  </select>
                                </div>
                            </div>
                            <div class="col-12">
...
@push('js')
    <script>
        $('#editUserModal').on('show.bs.modal', function(event) {
            ...
            console.log(select);
            select.val(json["subtype"]).trigger('change');
        })
