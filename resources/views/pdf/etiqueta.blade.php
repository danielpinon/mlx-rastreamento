  ...
  <body>
    <table>
        <tbody>
            ...
            <tr>
                <td class="text" colspan="2"><img src="data:image/png;base64,{!! base64_encode($generator->getBarcode($lote->LOTE_IDENTIFY, $generator::TYPE_CODE_128)) !!}" style="width: 100%"></td>
            </tr>
        </tbody>
    </table>
  </body>
